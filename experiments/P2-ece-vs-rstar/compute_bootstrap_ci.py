"""Add bootstrap 95% CI to the 5-judge cross-correlation analysis (P2).

Operates on the already-produced `experiments/analysis_hs2_5judges/per_judge_rstar.csv`
...
CSV = REPO / "experiments" / "analysis_hs2_5judges" / "per_judge_rstar.csv"
N_BOOTSTRAP = 10_000   # correlations with N=5 need more resamples for stable CI
SEED = 42
...
with open(HERE / "stats_with_ci.json", "w") as f:
